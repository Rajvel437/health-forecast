...
def predict():
    ...
    # Get input values from the form
        ...
        print('heart_probability_positive_class: ',heart_probability_positive_class)
        ...
        heart_lime_html = lung_lime_to_html(heart_lime_explanation)

        # Save Lung Lime explanation to HTML file
        heart_html_filename = 'static/lime_visualization.html'
        ...
        return render_template('result.html', result=heart_result, heart_lime_visualization_path=heart_html_filename)
    return render_template('index.html')
